...
setup(
    ...
    long_description='Python implementation of NEAT (NeuroEvolution of Augmenting Topologies), a ' +
                     'method developed by Kenneth O. Stanley for evolving arbitrary neural networks.',
    packages=['neat', 'neat/iznn', 'neat/nn', 'neat/ctrnn'],
    zip_safe=False,
    keywords=['NEAT', 'neural network', 'evolution', 'neuroevolution', 'machine learning'] # more?
    classifiers=[
